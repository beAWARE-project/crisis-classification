...
class Top006_Incident_Report_CRCL:
    'Class for manipulation (create, edit, delete) Topic_006 Incident Report CRCL'
    ...
    def __init__(self, msgIdentifier, sender, specificSender, sentUTC, district, code, note, recipients,
                 ...
                 attachments, dataStreamID, dataSeriesID, severity_value):

        # header variables
        self.topic_topicName = "TOP006_INCIDENT_REPORT_CRCL"
        ...
        self.topic_severity = severity_value
    ...
    def create_dictHeader_top006(self):
    ...
    def create_dictBody_top006(self):
